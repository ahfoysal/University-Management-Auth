...
const auth = (...roles) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!token) {
            throw new ApiError_1.default(http_status_1.default.UNAUTHORIZED, 'Unauthorized Request');
        }
        let verifiedUser = null;
        verifiedUser = jwtHelper_1.jwtHelpers.verifyToken(token, config_1.default.jwt.refresh);
