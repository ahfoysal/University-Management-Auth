...
const createFaculty = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_model_1.AcademicFaculty.create(data);
    return result;
});
const getFaculty = (filters, pagination) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteFaculty = (id) => __awaiter(void 0, void 0, void 0, function* () {
    yield academicFaculty_model_1.AcademicFaculty.deleteOne({ _id: id });
});
