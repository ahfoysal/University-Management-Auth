...
const generatedStudentId = (academicSemester) => __awaiter(void 0, void 0, void 0, function* () {
    const createUser = (yield (0, exports.findLastStudentId)()) || (0).toString().padStart(5, '0');
    let incrementedId = (parseInt(createUser) + 1).toString().padStart(5, '0');
    incrementedId = `${academicSemester && academicSemester.year.substring(2)}${academicSemester && academicSemester.code}${incrementedId}`;
